export const translations = {
    es: {
        ...
        'shop.week': 'Week',
        'shop.generated_at': 'Generated at',
        ...
        // Plural fallbacks
        'cat.VEGETABLES': 'Verduras',
        'cat.FRUITS': 'Frutas',
        'cat.PROTEINS': 'Proteínas',
        'cat.GRAINS': 'Granos',
        'cat.LEGUMES': 'Legumbres',
        'cat.FATS': 'Grasas',
        'cat.NUTS & SEEDS': 'Frutos Secos',
        'cat.CONDIMENTS': 'Condimentos',
        'cat.CARBOHYDRATES': 'Carbohidratos',
        ...
        'common.add': 'Añadir',
        'common.ingredientes': 'ingredientes',
        'common.ingredientes_count': '{{count}} ingredientes',
        'common.items_count': '{{count}} artículos',

        // AI Generator
        'gen.title': 'Generador de Dieta con IA',
        'gen.subtitle': 'Creamos un plan nutricional único basado en tu ciencia biológica y los últimos conocimientos médicos.',
        'gen.profile_title': 'Tu Perfil',
        'gen.age': 'Edad',
        'gen.sex': 'Sexo',
        'gen.weight': 'Peso (kg)',
        'gen.height': 'Altura (cm)',
        'gen.diet_type': 'Tipo de Dieta',
        'gen.restrictions': 'Restricciones',
        'gen.restrictions_placeholder': 'E.g. gluten, soja, nueces',
        'gen.submit': 'Generar Dieta Mágica',
        'gen.loading': 'Analizando fuentes de confianza...',
        'gen.result_title': 'Resultado del Análisis',
        'gen.result_subtitle': 'Plan generado con {{count}} días de balance nutricional.',
        'gen.save_title': '¿Te gusta este plan?',
        'gen.save_desc': 'Puedes guardarlo y activarlo desde tu panel principal.',
        'gen.save_btn': 'Guardar Plan',
        'gen.saving': 'Guardando...',
        'gen.empty_title': 'Tu plan aparecerá aquí',
        'gen.empty_desc': 'Configura tu perfil a la izquierda y pulsa el botón para comenzar el análisis.',
        'gen.error_auth': 'Debes iniciar sesión para generar una dieta.',
        'gen.error_gen': 'Error generando la dieta. Por favor intenta de nuevo.',
        'gen.error_save': 'Error al guardar el plan',
        'gen.success_save': 'Plan guardado con éxito',
        'gen.analyzing_library': 'Analizando biblioteca...',
        'gen.analyzing_desc': 'Nuestro algoritmo está consultando NutriFlow Biblioteca para encontrar la mejor combinación para ti.',
        ...
        'plans.subtitle': 'Gestiona tus planes semanales de dieta',
        'plans.generate': 'Generar nuevo plan',
        'plans.active_title': 'Planes Activos',
        'plans.history_title': 'Historial',
        'plans.no_active': 'No hay planes activos.',
        'plans.generate_now': 'Generar uno ahora',
        'plans.week_of': 'Semana del',
        'plans.kcal_day': 'kcal / día',
        'plans.delete_title': 'Eliminar Plan',
        'plans.delete_description': '¿Estás seguro de que deseas eliminar este plan permanentemente? Esta acción no se puede deshacer.',
        'plans.delete_confirm': '¿Estás seguro de que deseas eliminar este plan permanentemente?',
        'plans.status_active': 'Activo',
        'plans.gen_success': '¡Plan generado con éxito!',
        'plans.del_success': 'Plan eliminado correctamente',
        'plans.load_error': 'Error al cargar los planes',
        'plans.gen_error': 'Hubo un problema al generar el plan',
        'plans.weekly_plan': 'Plan Semanal',
        'plans.diet_exercise': 'Dieta + Ejercicio',
        'plans.shopping_list_btn': 'Lista de compra',
        'plans.nutritional': 'Plan Nutricional',
        'plans.exercise': 'Plan de Ejercicio',
        'plans.calendar': 'Calendario Semanal',
        'plans.meals': 'comidas',
        'plans.no_plan': 'Plan no encontrado',
        'plans.back_dashboard': 'Volver al panel',

        // Register & Onboarding Errors
        'reg.error_signup': 'Error al registrarse',
        'onboarding.error_complete': 'Error al completar el perfil',

        // Exercise
        'exercise.loading': 'Cargando tu plan de entrenamiento...',
        'exercise.title': 'Plan de Ejercicio',
        'exercise.days_per_week': '{{count}} días de entrenamiento por semana',
        'exercise.active_days': 'Días Activos',
        'exercise.kcal_week': 'kcal/semana',
        'exercise.routine': 'Rutina Semanal',
        'exercise.no_plan': 'No hay plan de ejercicios disponible para este plan.',
        'exercise.rest_day': 'Día de Descanso',
        'exercise.rest_desc': 'Tu cuerpo necesita recuperarse. Aprovecha para hidratarte, estirar suavemente y dormir bien.',
        'exercise.descanso': 'Descanso',
        'exercise.type_fullbody': 'Cuerpo Completo',
        'exercise.type_upper': 'Tren Superior',
        'exercise.type_lower': 'Tren Inferior',
        'exercise.type_core': 'Abdomen',
        'exercise.type_strength': 'Fuerza',
        'exercise.type_cardio': 'Cardio',
        'exercise.type_hiit': 'HIIT',
        'exercise.type_flexibility': 'Flexibilidad',
        'exercise.type_balance': 'Equilibrio',
        'exercise.type_meditation': 'Meditación',
        'exercise.active_recovery': 'Recuperación Activa',

        // Macros
        'macros.title': 'Objetivo Diario',
        'macros.analysis': 'Análisis NutriFlow',
        'macros.desc': 'Balance nutricional optimizado según tu perfil biológico y objetivos de salud.',
        'macros.calories': 'Calorías',
        'macros.protein': 'Proteínas',
        'macros.carbs': 'Carbohidratos',
        'macros.fats': 'Grasas',
        'macros.cal_short': 'Cal',
        'macros.prot_short': 'Prot',
        'macros.carb_short': 'Carb',
        'macros.fat_short': 'Grasas',
        ...
        'errors.username_taken': 'Este nombre de usuario ya está en uso. Elige otro.',
        'errors.username_check_error': 'Error al verificar disponibilidad del nombre de usuario.',
    ...
    en: {
        ...
        'cat.LEGUMES': 'Legumes',
        'cat.FATS': 'Fats',
        'cat.NUTS & SEEDS': 'Nuts & Seeds',
        'cat.CONDIMENTS': 'Condiments',
        'cat.CARBOHYDRATES': 'Carbohydrates',
        ...
        'common.items': 'items',
        'common.add': 'Add',
        'common.ingredientes': 'ingredients',
        'common.ingredientes_count': '{{count}} ingredients',
        'common.items_count': '{{count}} items',

        // AI Generator
        'gen.title': 'AI Diet Generator',
        'gen.subtitle': 'We create a unique nutritional plan based on your biological science and latest medical knowledge.',
        'gen.profile_title': 'Your Profile',
        'gen.age': 'Age',
        'gen.sex': 'Sex',
        'gen.weight': 'Weight (kg)',
        'gen.height': 'Height (cm)',
        'gen.diet_type': 'Diet Type',
        'gen.restrictions': 'Restrictions',
        'gen.restrictions_placeholder': 'E.g. gluten, soy, nuts',
        'gen.submit': 'Generate Magic Diet',
        'gen.loading': 'Analyzing trusted sources...',
        'gen.result_title': 'Analysis Result',
        'gen.result_subtitle': 'Plan generated with {{count}} days of nutritional balance.',
        'gen.save_title': 'Do you like this plan?',
        'gen.save_desc': 'You can save and activate it from your main dashboard.',
        'gen.save_btn': 'Save Plan',
        'gen.saving': 'Saving...',
        'gen.empty_title': 'Your plan will appear here',
        'gen.empty_desc': 'Configure your profile on the left and press the button to start the analysis.',
        'gen.error_auth': 'You must log in to generate a diet.',
        'gen.error_gen': 'Error generating diet. Please try again.',
        'gen.error_save': 'Error saving plan',
        'gen.success_save': 'Plan saved successfully',
        'gen.analyzing_library': 'Analyzing library...',
        'gen.analyzing_desc': 'Our algorithm is consulting the NutriFlow Library to find the best combination for you.',
        ...
        'plans.weekly_plan': 'Weekly Plan',
        'plans.diet_exercise': 'Diet + Exercise',
        'plans.shopping_list_btn': 'Shopping list',
        'plans.nutritional': 'Nutritional Plan',
        'plans.exercise': 'Exercise Plan',
        'plans.calendar': 'Weekly Calendar',
        'plans.meals': 'meals',
        'plans.no_plan': 'Plan not found',
        'plans.back_dashboard': 'Back to dashboard',

        // Exercise
        'exercise.loading': 'Loading your workout plan...',
        'exercise.title': 'Exercise Plan',
        'exercise.days_per_week': '{{count}} workout days per week',
        'exercise.active_days': 'Active Days',
        'exercise.kcal_week': 'kcal/week',
        'exercise.routine': 'Weekly Routine',
        'exercise.no_plan': 'No exercise plan available for this plan.',
        'exercise.rest_day': 'Rest Day',
        'exercise.rest_desc': 'Your body needs to recover. Take the opportunity to hydrate, stretch gently, and sleep well.',
        'exercise.descanso': 'Rest',
        'exercise.type_fullbody': 'Full Body',
        'exercise.type_upper': 'Upper Body',
        'exercise.type_lower': 'Lower Body',
        'exercise.type_core': 'Core',
        'exercise.type_strength': 'Strength',
        'exercise.type_cardio': 'Cardio',
        'exercise.type_hiit': 'HIIT',
        'exercise.type_flexibility': 'Flexibility',
        'exercise.type_balance': 'Balance',
        'exercise.type_meditation': 'Meditation',
        'exercise.active_recovery': 'Active Recovery',

        // Macros
        'macros.title': 'Daily Goal',
        'macros.analysis': 'NutriFlow Analysis',
        'macros.desc': 'Optimized nutritional balance based on your biological profile and health goals.',
        ...
        'errors.username_taken': 'This username is already taken. Choose another.',
        'errors.username_check_error': 'Error checking username availability.',
        ...
        'onboarding.allergens_selected': 'alérgenos seleccionados',
        'onboarding.allergens_none_selected': 'Sin alergias seleccionadas',
        'onboarding.allergens_plan_avoid': 'Tu plan will be generated avoiding these ingredients.',

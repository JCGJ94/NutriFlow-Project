...
const translations = {
  es: {
    ...
    'shop.export_pdf': 'Descargar PDF',
    'shop.pdf_downloaded': 'PDF descargado correctamente',
    'shop.shared_success': 'Lista compartida correctamente',
    'shop.share_error': 'Error al compartir la lista',
    'shop.copied_clipboard': 'Copiado al portapapeles',
    'shop.item_added': 'Producto añadido',
    'shop.weekly_title': 'Tu lista de compra semanal',
    'shop.progress': '{{checked}} de {{total}} productos',
    'shop.custom_section': 'Productos personalizados',
    ...
    'reg.password_placeholder': 'Crea una contraseña segura',
  ...
  en: {
    ...
    'shop.print': 'Print',
    'shop.share': 'Share',
    'shop.export_pdf': 'Download PDF',
    'shop.pdf_downloaded': 'PDF downloaded successfully',
    'shop.shared_success': 'List shared successfully',
    'shop.share_error': 'Error sharing list',
    'shop.copied_clipboard': 'Copied to clipboard',
    'shop.item_added': 'Item added',
    'shop.weekly_title': 'Your weekly shopping list',
    'shop.progress': '{{checked}} of {{total}} items',
    'shop.custom_section': 'Custom Items',
    ...
    'reg.password_placeholder': 'Create a secure password',
